/*
 ...
 Note:
  ...
  2) In your web page, have the output <div> BEFORE this script. The <div> looks like this:
       <div id="detectSilver_output"></div>
...
(function(){
 ...
 var out = document.getElementById("detectSilver_output");  // node for output text
 ...
 var docWrite = function(text)
 {
   ...
   var P = {name:"Silverlight", status:-1, version:null, minVersion:"5,0,0,0"};
